...
4.  **quero que vc desevolva um projeto funcional com o pyqt6**: todo o código deve ser funcional e testado. Se o usuário pedir um projeto, forneça um exemplo completo que possa ser executado diretamente.
"""
